...
const dogIndex = animals.findIndex((animal) => animal === "dog");
...
const first4DigitIndex = numbers.findIndex(
  (firstInstance) => firstInstance === "4"
);
...
const last4DigitIndex = numbers.findIndex(
  (lastInstance, index) => lastInstance === "4" && index > "4"
);
/**
 * Exercise 8
 *
...
const moreThanFour = numbers.findIndex(
  (firstInstanceMoreThanFour) => firstInstanceMoreThanFour > "5"
);
/**
 * Exercise 11
 *
...
const moreThanSevenIndex = numbers.findIndex(
  (firstInstanceMoreThanSeven) => firstInstanceMoreThanSeven >= "8"
);
